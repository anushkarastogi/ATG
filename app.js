...
animateAll({ classes: ['.s1', '.ad-1', '.cta-1', '.img-1', '.img-2', '.logo-1', '.dot-1'], svgDot: '.dotsfill1', trigger: '.slide-3', start: 'top 105%', end: 'top 50%', color: '#550080', backgroundColor: '#dedede', strokeLength: 0 });
animateAll({ classes: ['.s2', '.ad-2', '.cta-2', '.img-3', '.img-4', '.dot-2'], svgDot: '.dotsfill2',trigger: '.slide-3', start: 'top 50%', end: 'top 0%', color: '#4C27CD', backgroundColor: '#1B0361', strokeLength: (140 * 1) });
...
animateAll({ classes: ['.s6', '.ad-6', '.cta-6', '.img-16', '.img-17', '.img-18', '.img-19', '.dot-6'], svgDot: '.dotsfill6',trigger: '.slide-5', start: 'top 50%', end: 'top 0%', color: '#114BA0', backgroundColor: '#1a1a3b', strokeLength: (140 * 5) });
animateAll({ classes: ['.s7', '.ad-7', '.cta-7', '.img-14', '.img-15', '.dot-7'], svgDot: '.dotsfill7',trigger: '.slide-6', start: 'top 100%', end: 'top -10%', color: '#0E1139', backgroundColor: '#141647', strokeLength: (140 * 6) });